...
echo "=========================================="
echo "🚀 새 애플리케이션 시작 중 (Parallel GC)..."
echo "=========================================="

# 로그 파일에 타임스탬프 추가
echo "===== $(date) Parallel GC 모드로 시작 =====" >> app.log

# 애플리케이션 시작 - Parallel GC 옵션
...
if pgrep -f "hufs_cheongwon-0.0.1-SNAPSHOT.jar" > /dev/null; then
  echo "✅ 애플리케이션이 성공적으로 시작되었습니다! (Parallel GC)"
